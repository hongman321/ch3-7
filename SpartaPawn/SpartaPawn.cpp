...
#include "SpartaPawnPlayerController.h"
...
void ASpartaPawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	{
		// 현재 컨트롤러가 ASpartaPawnPlayerController임을 확인 후 입력 액션을 가져옴
		if (ASpartaPawnPlayerController* MyController = Cast<ASpartaPawnPlayerController>(GetController()))
		{
			// --- MoveAction 바인딩 ---
